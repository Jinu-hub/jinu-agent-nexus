...
// worker/content-audio.ts, worker/content-briefs.ts, worker/item-contents.ts
// (and later Market Memory modules). This file stays the single place to
// build a client and verify secrets + network.
//
