...
| Agent / MyMemory instance | `src/lib/agent-identity.ts` + `use-agent-instance.ts` + `src/lib/auth.tsx` — Phase 1 `guest_*`; Phase 2 Supabase user id. **`topic_labels` always `"default"`.** [`INSTANCE_DATA.md`](./INSTANCE_DATA.md) |
